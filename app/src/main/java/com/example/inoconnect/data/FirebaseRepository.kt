...
class FirebaseRepository {
    ...
    // ... [Previous code for Projects, Connection Status, Auth, Event Logic] ...
    // (Keep all existing methods like getUserProjectsFlow, getConnectionStatusFlow, registerUser, loginUser, etc.)

    // --- REPLACED: STORAGE & MESSAGE SENDING ---
    ...
    // Kept for backward compatibility if used elsewhere, redirects to generic
    ...
    suspend fun sendDirectMessage(
        ...
        // 6. Send Notification to the Receiver
        sendNotification(
            toUserId = toUserId,
    ...
    // ... [Keep the rest of the file unchanged: getProjectMessages, Network functions, etc.] ...

    // (Ensure you include all the original methods below this point, I am omitting them here for brevity
